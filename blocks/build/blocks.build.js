...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_deprecation__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_deprecation___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_deprecation__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_once__ = __webpack_require__(15);
...
class RequestError extends Error {
  constructor(message, statusCode, options) {
    ...
    Object.defineProperty(this, "code", {
      get() {
        logOnce(new __WEBPACK_IMPORTED_MODULE_0_deprecation__["Deprecation"]("[@octokit/request-error] `error.code` is deprecated, use `error.status`."));
        return statusCode;
      }
...
const deprecate = __webpack_require__(16)
const getPageLinks = __webpack_require__(17)
const HttpError = __webpack_require__(160)
...
const Octokit = __webpack_require__(115)

const CORE_PLUGINS = [
  __webpack_require__(134),
  __webpack_require__(135), // deprecated: remove in v17
  ...
  __webpack_require__(158) // deprecated: remove in v17
]
...
const Octokit = __webpack_require__(116)
const registerPlugin = __webpack_require__(133)
...
const normalizePaginatedListResponse = __webpack_require__(147)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__style_scss__ = __webpack_require__(102);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__editor_scss__ = __webpack_require__(103);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__wordpress_components__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__wordpress_components___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7__wordpress_components__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__card_js__ = __webpack_require__(105);
...
var Octokit = __webpack_require__(57);

var ghClient = new Octokit({
...
registerBlockType('gitblock/org-members', {
	...
	icon: 'groups',
	category: 'common',
	keywords: [__('gitblock'), __('org'), __('Github')],
	attributes: {
		orgName: {
			type: 'text'
		},
	...
	edit: function (_Component) {
		...
		function edit(props) {
			...
			var _this = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_possibleConstructorReturn___default()(this, (edit.__proto__ || __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(edit)).call(this, props));

			_this.state = {
				value: _this.props.attributes.orgName ? _this.props.attributes.orgName : '',
				orgMembers: _this.props.attributes.orgMembers ? _this.props.attributes.orgMembers : ''
			};

			_this.onChange = _this.onChange.bind(_this);
			_this.getOrgInfo = _this.getOrgInfo.bind(_this);
			return _this;
		}

		__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(edit, [{
			key: 'populateOrgInfo',
			value: function populateOrgInfo(org) {
				var _this2 = this;

				ghClient.request('GET https://api.github.com/orgs/' + org).then(function (data) {
					if (data.data) {
						var orgInfo = data.data;

						var days = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
						var d = new Date(orgInfo.created_at);
						var dayName = d.getDate() + ' ' + days[d.getDay()] + ' ' + d.getFullYear();

						_this2.props.setAttributes({ orgName: org });
						_this2.props.setAttributes({ orgRepos: orgInfo.public_repos });
						_this2.props.setAttributes({ orgAvatar: orgInfo.avatar_url });
						_this2.props.setAttributes({ orgURL: orgInfo.html_url });
						_this2.props.setAttributes({ orgLogin: orgInfo.login });
						_this2.props.setAttributes({ orgCreated: dayName });
						_this2.props.setAttributes({ orgLocation: orgInfo.location });

						ghClient.request('GET https://api.github.com/orgs/' + org + '/public_members').then(function (orgdata) {
							if (orgdata.data.length) {
								_this2.props.setAttributes({
									orgMembers: orgdata.data.map(function (d) {
										return {
											login: d.login,
								...
								_this2.props.setAttributes({ userOrgs: [] });
							}
						});
					}
				});
			...
			value: function render() {
				...
				if (this.props && gitblock_var.token) {
					returnContent.push(wp.element.createElement(__WEBPACK_IMPORTED_MODULE_7__wordpress_components__["TextControl"], {
						label: 'Enter Organisation Name',
						value: this.state.value,
						onChange: this.onChange
					}));
					returnContent.push(wp.element.createElement(
						__WEBPACK_IMPORTED_MODULE_7__wordpress_components__["Button"],
						{ isDefault: true, onClick: this.getOrgInfo },
						'Submit'
					));
				}
				...
				if (attributes.orgName && attributes.orgURL && attributes.orgAvatar && attributes.orgMembers && gitblock_var.token) {
					returnContent.push(wp.element.createElement(
						...
						wp.element.createElement(__WEBPACK_IMPORTED_MODULE_8__card_js__["a" /* Card */], {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__fortawesome_react_fontawesome__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__fortawesome_free_brands_svg_icons__ = __webpack_require__(114);
...
var Card = function (_Component) {
	...
	function Card(props) {
		...
		var _this = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_possibleConstructorReturn___default()(this, (Card.__proto__ || __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(Card)).call(this, props));
	...
	__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(Card, [{
		...
		value: function render() {
			var _props = this.props,
			    orgAvatar = _props.orgAvatar,
			    orgRepos = _props.orgRepos,
			    orgURL = _props.orgURL,
			    orgMembers = _props.orgMembers,
			    orgLogin = _props.orgLogin,
			    orgCreated = _props.orgCreated,
			    orgLocation = _props.orgLocation;
				...
				wp.element.createElement(
					...
					wp.element.createElement(
						...
						wp.element.createElement(
							...
							wp.element.createElement(
								'div',
								{ className: 'login_top center' },
								orgLogin
							),
							wp.element.createElement(
								'div',
								{ className: 'profile_link center' },
								wp.element.createElement(
									'a',
									{ href: orgURL, target: '_blank', rel: 'noopener noreferrer' },
									'Visit Profile'
								)
							),
							wp.element.createElement('img', { alt: 'Org Avatar', src: orgAvatar })
						),
						wp.element.createElement(
							'div',
							{ className: 'more-info' },
							...
							wp.element.createElement(
								'div',
								{ className: 'coords' },
								orgMembers.length > 0 && wp.element.createElement(
									'h6',
									null,
									'Public Members'
								),
								orgMembers.length > 0 && wp.element.createElement(
									'div',
									{ className: 'orgContainer', title: 'Scroll to view all members if not visible.' },
									orgMembers.map(function (orgMember) {
										return wp.element.createElement(
											'a',
											{ key: orgMember.login, href: orgMember.html_url, target: '_blank', rel: 'noopener noreferrer' },
											wp.element.createElement('img', { key: orgMember.login, src: orgMember.avatar_url, alt: orgMember.login + '\'s Avatar' })
										);
									})
								)
							),
							wp.element.createElement(
								...
								wp.element.createElement(
									...
									wp.element.createElement(__WEBPACK_IMPORTED_MODULE_5__fortawesome_react_fontawesome__["a" /* FontAwesomeIcon */], { icon: __WEBPACK_IMPORTED_MODULE_6__fortawesome_free_brands_svg_icons__["a" /* faGithubAlt */] }),
									wp.element.createElement(
										'div',
										{ className: 'value' },
										orgRepos
					...
					wp.element.createElement(
						...
						wp.element.createElement(
							'span',
							null,
							orgCreated && 'Created on: ' + orgCreated
						),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__fortawesome_fontawesome_svg_core__ = __webpack_require__(107);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(2), __webpack_require__(108).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2), __webpack_require__(110)))
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return faGithubAlt; });
...
const factory = __webpack_require__(58)
...
const Hook = __webpack_require__(127)

const parseClientOptions = __webpack_require__(131)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__octokit_endpoint__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_universal_user_agent__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_universal_user_agent___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_universal_user_agent__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_is_plain_object__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_node_fetch__ = __webpack_require__(125);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__octokit_request_error__ = __webpack_require__(14);
...
function fetchWrapper(requestOptions) {
  if (Object(__WEBPACK_IMPORTED_MODULE_2_is_plain_object__["a" /* default */])(requestOptions.body) || Array.isArray(requestOptions.body)) {
  ...
  let status;
  let url;
  const fetch = requestOptions.request && requestOptions.request.fetch || __WEBPACK_IMPORTED_MODULE_3_node_fetch___default.a;
  return fetch(requestOptions.url, Object.assign({
    ...
    if (requestOptions.method === "HEAD") {
      ...
      throw new __WEBPACK_IMPORTED_MODULE_4__octokit_request_error__["RequestError"](response.statusText, status, {
        headers,
    ...
    if (status === 304) {
      throw new __WEBPACK_IMPORTED_MODULE_4__octokit_request_error__["RequestError"]("Not modified", status, {
        headers,
        request: requestOptions
      });
    }
    ...
    if (status >= 400) {
      return response.text().then(message => {
        const error = new __WEBPACK_IMPORTED_MODULE_4__octokit_request_error__["RequestError"](message, status, {
          headers,
          request: requestOptions
        });
    ...
    if (error instanceof __WEBPACK_IMPORTED_MODULE_4__octokit_request_error__["RequestError"]) {
      throw error;
    }

    throw new __WEBPACK_IMPORTED_MODULE_4__octokit_request_error__["RequestError"](error.message, 500, {
      headers,
      request: requestOptions
    });
  });
...
const request = withDefaults(__WEBPACK_IMPORTED_MODULE_0__octokit_endpoint__["a" /* endpoint */], {
  headers: {
    "user-agent": "octokit-request.js/".concat(VERSION, " ").concat(__WEBPACK_IMPORTED_MODULE_1_universal_user_agent___default()())
  }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_deepmerge__ = __webpack_require__(119);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_is_plain_object__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_url_template__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_url_template___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_url_template__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_universal_user_agent__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_universal_user_agent___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_universal_user_agent__);
...
function merge(defaults, route, options) {
  ...
  const mergedOptions = __WEBPACK_IMPORTED_MODULE_0_deepmerge___default.a.all([defaults, options].filter(Boolean), {
    isMergeableObject: __WEBPACK_IMPORTED_MODULE_1_is_plain_object__["a" /* default */]
...
function parse(options) {
  ...
  url = __WEBPACK_IMPORTED_MODULE_2_url_template___default.a.parse(url).expand(parameters);
...
const userAgent = "octokit-endpoint.js/".concat(VERSION, " ").concat(__WEBPACK_IMPORTED_MODULE_3_universal_user_agent___default()());
const DEFAULTS = {
  method: "GET",
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_isobject__ = __webpack_require__(121);
/*!
...
function isObjectObject(o) {
  return Object(__WEBPACK_IMPORTED_MODULE_0_isobject__["a" /* default */])(o) === true
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = isPlainObject;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_isobject__ = __webpack_require__(124);
/*!
 * is-plain-object <https://github.com/jonschlinkert/is-plain-object>
 *
 * Copyright (c) 2014-2017, Jon Schlinkert.
...
var register = __webpack_require__(128)
var addHook = __webpack_require__(129)
var removeHook = __webpack_require__(130)
...
const { Deprecation } = __webpack_require__(11)
const getUserAgent = __webpack_require__(41)
const once = __webpack_require__(15)

const pkg = __webpack_require__(132)
...
module.exports = {"_args":[["@octokit/rest@16.27.3","/Users/abhijitrakas/sites/wpgrphql/wp-content/plugins/gitblock"]],"_from":"@octokit/rest@16.27.3","_id":"@octokit/rest@16.27.3","_inBundle":false,"_integrity":"sha512-WWH/SHF4kus6FG+EAfX7/JYH70EjgFYa4AAd2Lf1hgmgzodhrsoxpXPSZliZ5BdJruZPMP7ZYaPoTrYCCKYzmQ==","_location":"/@octokit/rest","_phantomChildren":{},"_requested":{"type":"version","registry":true,"raw":"@octokit/rest@16.27.3","name":"@octokit/rest","escapedName":"@octokit%2frest","scope":"@octokit","rawSpec":"16.27.3","saveSpec":null,"fetchSpec":"16.27.3"},"_requiredBy":["/"],"_resolved":"https://registry.npmjs.org/@octokit/rest/-/rest-16.27.3.tgz","_spec":"16.27.3","_where":"/Users/abhijitrakas/sites/wpgrphql/wp-content/plugins/gitblock","author":{"name":"Gregor Martynus","url":"https://github.com/gr2m"},"bugs":{"url":"https://github.com/octokit/rest.js/issues"},"bundlesize":[{"path":"./dist/octokit-rest.min.js.gz","maxSize":"33 kB"}],"contributors":[{"name":"Mike de Boer","email":"info@mikedeboer.nl"},{"name":"Fabian Jakobs","email":"fabian@c9.io"},{"name":"Joe Gallo","email":"joe@brassafrax.com"},{"name":"Gregor Martynus","url":"https://github.com/gr2m"}],"dependencies":{"@octokit/request":"^4.0.1","@octokit/request-error":"^1.0.2","atob-lite":"^2.0.0","before-after-hook":"^1.4.0","btoa-lite":"^1.0.0","deprecation":"^2.0.0","lodash.get":"^4.4.2","lodash.set":"^4.3.2","lodash.uniq":"^4.5.0","octokit-pagination-methods":"^1.1.0","once":"^1.4.0","universal-user-agent":"^2.0.0","url-template":"^2.0.8"},"description":"GitHub REST API client for Node.js","devDependencies":{"@gimenete/type-writer":"^0.1.3","@octokit/fixtures-server":"^5.0.1","@octokit/routes":"20.4.4","@types/node":"^12.0.0","bundlesize":"^0.17.0","chai":"^4.1.2","compression-webpack-plugin":"^2.0.0","coveralls":"^3.0.0","glob":"^7.1.2","http-proxy-agent":"^2.1.0","lodash.camelcase":"^4.3.0","lodash.merge":"^4.6.1","lodash.upperfirst":"^4.3.1","mkdirp":"^0.5.1","mocha":"^6.0.0","mustache":"^3.0.0","nock":"^10.0.0","npm-run-all":"^4.1.2","nyc":"^14.0.0","prettier":"^1.14.2","proxy":"^0.2.4","semantic-release":"^15.0.0","sinon":"^7.2.4","sinon-chai":"^3.0.0","sort-keys":"^3.0.0","standard":"^12.0.0","string-to-arraybuffer":"^1.0.0","string-to-jsdoc-comment":"^1.0.0","typescript":"^3.3.1","webpack":"^4.0.0","webpack-bundle-analyzer":"^3.0.0","webpack-cli":"^3.0.0"},"files":["index.js","index.d.ts","lib","plugins"],"homepage":"https://github.com/octokit/rest.js#readme","keywords":["octokit","github","rest","api-client"],"license":"MIT","name":"@octokit/rest","nyc":{"ignore":["test"]},"publishConfig":{"access":"public"},"release":{"publish":["@semantic-release/npm",{"path":"@semantic-release/github","assets":["dist/*","!dist/*.map.gz"]}]},"repository":{"type":"git","url":"git+https://github.com/octokit/rest.js.git"},"scripts":{"build":"npm-run-all build:*","build:browser":"npm-run-all build:browser:*","build:browser:development":"webpack --mode development --entry . --output-library=Octokit --output=./dist/octokit-rest.js --profile --json > dist/bundle-stats.json","build:browser:production":"webpack --mode production --entry . --plugin=compression-webpack-plugin --output-library=Octokit --output-path=./dist --output-filename=octokit-rest.min.js --devtool source-map","build:ts":"node scripts/generate-types","coverage":"nyc report --reporter=html && open coverage/index.html","generate-bundle-report":"webpack-bundle-analyzer dist/bundle-stats.json --mode=static --no-open --report dist/bundle-report.html","generate-routes":"node scripts/generate-routes","postvalidate:ts":"tsc --noEmit --target es6 test/typescript-validate.ts","prebuild:browser":"mkdirp dist/","pretest":"standard","prevalidate:ts":"npm run -s build:ts","start-fixtures-server":"octokit-fixtures-server","test":"nyc mocha test/mocha-node-setup.js \"test/*/**/*-test.js\"","test:browser":"cypress run --browser chrome","test:memory":"mocha test/memory-test","validate:ts":"tsc --target es6 --noImplicitAny index.d.ts"},"standard":{"globals":["describe","before","beforeEach","afterEach","after","it","expect","cy"],"ignore":["/docs"]},"types":"index.d.ts","version":"16.27.3"}
...
const authenticate = __webpack_require__(136)
const beforeRequest = __webpack_require__(137)
const requestError = __webpack_require__(139)
...
const uniq = __webpack_require__(138)
...
const { RequestError } = __webpack_require__(14)
...
const beforeRequest = __webpack_require__(141)
const requestError = __webpack_require__(144)
const validate = __webpack_require__(145)
...
const withAuthorizationPrefix = __webpack_require__(142)
...
const atob = __webpack_require__(143)
...
const iterator = __webpack_require__(60)
const paginate = __webpack_require__(148)
...
const registerEndpoints = __webpack_require__(151)
...
const ROUTES = __webpack_require__(153)
...
const validate = __webpack_require__(155)
...
const { RequestError } = __webpack_require__(14)
const get = __webpack_require__(156)
const set = __webpack_require__(157)
...
function paginationMethodsPlugin (octokit) {
  octokit.getFirstPage = __webpack_require__(159).bind(null, octokit)
  octokit.getLastPage = __webpack_require__(161).bind(null, octokit)
  octokit.getNextPage = __webpack_require__(162).bind(null, octokit)
  octokit.getPreviousPage = __webpack_require__(163).bind(null, octokit)
  octokit.hasFirstPage = __webpack_require__(164)
  octokit.hasLastPage = __webpack_require__(165)
  octokit.hasNextPage = __webpack_require__(166)
...
const getPage = __webpack_require__(21)
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__style_scss__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__style_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__style_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__editor_scss__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__editor_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__editor_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit__ = __webpack_require__(171);
//  Import CSS.
...
registerBlockType('gitblock/user', {
	...
	keywords: [__('gitblock'), __('user'), __('Github')],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_babel_runtime_helpers_inherits__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_react_autocomplete__ = __webpack_require__(172);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__octokit_rest__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__octokit_rest___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6__octokit_rest__);
...
var ghClient = new __WEBPACK_IMPORTED_MODULE_6__octokit_rest___default.a({
	auth: 'token ' + gitblock_var.token
});
...
var edit = function (_Component) {
	...
	function edit(props) {
		...
		_this.onSelectGitUser = _this.onSelectGitUser.bind(_this);
		return _this;
	}
	...
	__WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(edit, [{
		...
		value: function setUserName(event) {
			...
			var gitUserName = event.target.value;
			...
			ghClient.search.users({ q: gitUserName }).then(function (data) {
				var result = data.data.items.map(function (user) {
					return user.login;
				});
				_this2.setState({ users: result ? result : [] });
			});
		}
	}, {
		key: 'onSelectGitUser',
		value: function onSelectGitUser(gitUserName) {
			this.props.setAttributes({ userName: gitUserName });
		...
		value: function render() {
			var _props = this.props,
			    ...
			    userSelected = _props$attributes.userSelected,
			...
			var layoutControls = [{
				...
				onClick: function onClick() {
					return setAttributes({ userSelected: null });
				},
			...
			return wp.element.createElement(
				...
				!userSelected ? wp.element.createElement(__WEBPACK_IMPORTED_MODULE_5_react_autocomplete___default.a, {
...
var scrollIntoView = __webpack_require__(174);
